...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/Cloverhound/gosnmp)](https://pkg.go.dev/github.com/Cloverhound/gosnmp)
...
[gosnmp/gosnmp](https://github.com/Cloverhound/gosnmp).
...
```shell
go get github.com/Cloverhound/gosnmp
```

# Documentation

https://pkg.go.dev/github.com/Cloverhound/gosnmp
...
1. [fork this repo on the GitHub webpage](https://github.com/Cloverhound/gosnmp/fork)
1. `go get github.com/Cloverhound/gosnmp`
1. `cd $GOPATH/src/github.com/Cloverhound/gosnmp`
...
Please create an [issue](https://github.com/Cloverhound/gosnmp/issues) on
...
gocov test github.com/Cloverhound/gosnmp | gocov-html > gosnmp.html && firefox gosnmp.html &
```
